        ...
        return (
          ...
          >
            <POPUP className="img-content relative">
              <div className="h-[280px] w-[620px] md:h-[260px] md:w-[92%] hover:scale-125 transition duration-500 cursor-pointer shadow-xl rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] sm:bg-cover mx-auto">
                <img
                  src={data.img}
                  alt={data.title}
